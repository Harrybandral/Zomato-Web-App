...
function Home() {
  ...
  let getMealTypeList = async () => {
    try {
      let url = "https://zomato-web-api.onrender.com/api/get-meal-type-list";
  ...
  let getLocationList = async () => {
    try {
      let url = "https://zomato-web-api.onrender.com/api/get-location-list";
      let response = await axios.get(url);
      let data = response.data;
  ...
  let getRestaurantListByLocId = async () => {
    let url =
      "https://zomato-web-api.onrender.com/api/get-restaurant-list-by-loc-id/" +
